...
# downstream by setting OMP_NUM_THREADS in your shell or before `import tlapse4d`
# if you need to cap thread count.
os.environ.setdefault("OMP_NUM_THREADS", str(os.cpu_count() or 1))

import tlapse4d.coreg
import tlapse4d.io
import tlapse4d.metashape
import tlapse4d.plot
import tlapse4d.preprocess
